...
function getSeverity(insight: PersistedInsight): InsightSeverity {
  ...
  if (
    ...
    VALID_SEVERITIES.has(fromEvidence as InsightSeverity)
  ) {
...
export function InsightCard({ insight }: InsightCardProps) {
  ...
  const isAiGenerated = insight.sourceKind === "ai";
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            {isAiGenerated ? (
              <span
                className="shrink-0 rounded-full border border-ink/15 bg-ink/5 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.14em] text-ink/50"
                title="Generated by AI from your logged data — not a substitute for professional advice."
              >
                AI
              </span>
            ) : null}
