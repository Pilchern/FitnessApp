...
const bodyMetricRowSchema = z.object({
  ...
  waist_hip_in: z.number().nullable(),
  waist_gut_in: z.number().nullable(),
...
export function mapBodyMetricRow(row: BodyMetricRow): BodyMetric {
  return {
    ...
    waistHipIn: row.waist_hip_in,
    waistGutIn: row.waist_gut_in,
...
function toBodyMetricInsert(input: CreateBodyMetricInput) {
  return {
    ...
    waist_hip_in: input.waistHipIn ?? null,
    waist_gut_in: input.waistGutIn ?? null,
...
function toBodyMetricUpdate(input: UpdateBodyMetricInput) {
  ...
  return compactRecord({
    ...
    waist_hip_in: input.waistHipIn,
    waist_gut_in: input.waistGutIn,
